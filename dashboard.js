...
function updateTimeSeries() {
    ...
    Plotly.newPlot('regimeChart', [
        ...
        xaxis: { type: 'category', title: null, tickangle: -45, tickfont: { size: 9 } },
    ...
    container.innerHTML = `
        <div class="methodology-content">
            ...
            <p>
                ...
                This measures execution quality relative to the overnight indication.
            </p>
            ...
            <h3>Overnight Price Indication</h3>
            <p>The lambda coefficient measures how far the overnight VWAP (P<sub>v</sub>) sits along the indication from prior close (P<sub>t</sub>) to next-day open (P<sub>a</sub>).</p>
            <div class="methodology-diagram">
                <svg viewBox="0 0 800 350" xmlns="http://www.w3.org/2000/svg" class="diagram-svg">
                    ...
                    <!-- Overnight dashed indication line -->
            ...
            <div class="methodology-diagram continuity-diagram">
                <div class="continuity-grid">
                    ...
                    <div class="continuity-card">
                        <div class="continuity-label">CONTINUOUS <span class="label-sub">(Downward Indication)</span></div>
                    ...
                    <div class="continuity-card">
                        <div class="continuity-label">CONTINUOUS <span class="label-sub">(Upward Indication)</span></div>
                        <svg viewBox="0 0 280 160" xmlns="http://www.w3.org/2000/svg" class="diagram-svg-small">
                            <rect width="280" height="160" fill="transparent"/>
